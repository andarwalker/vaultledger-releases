...
1. Distribute, sublicense, rent, lease, sell, or otherwise transfer the Software or any portion of it to any third party.
2. Reverse engineer, decompile, or disassemble the Software, except to the extent expressly permitted by applicable law.
3. Modify, adapt, or create derivative works of the Software.
4. Remove or alter any copyright, trademark, or other proprietary notices.
5. Use the Software to violate any law or the rights of any third party.
6. Use the Software to process data that you are not authorized to access (e.g. someone else's email inbox without their permission).
7. Bypass, attempt to bypass, or share credentials for the closed-beta license gate.

## 4. Your data

The Software is local-first. The data you generate by using the Software (orders, emails, prices, etc.) is stored on your device. See [`PRIVACY.md`](./PRIVACY.md) for the full description of what data, if any, leaves your device. Licensor disclaims any responsibility for backing up your local data; you are responsible for your own backups (the in-app **Settings → Data → Export** feature is provided for this purpose).
